...
@Transactional
public class PostOfficeService implements Service<PostOffice> {
	...
	@Override
	public List<PostOffice> getAllFiltered(CriteriaQuery<PostOffice> query) {
		return postOfficeDao.getAllFiltered(query);
	}
